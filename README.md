...
Code Sense AI is a Node.js service for analyzing repositories and pull requests. It combines repository scanning, dependency graphing, rule-based validation, semantic retrieval with ChromaDB, and Gemini-powered AI review.
